namespace listmaker
{
	partial class Form1
	{
		...
		private ctrl_Spinner ctrl_To_5 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_To_4 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_To_3 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_To_2 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_To_1 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_To_0 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_From_5 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_From_4 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_From_3 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_From_2 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_From_1 = new ctrl_Spinner();
		private ctrl_Spinner ctrl_From_0 = new ctrl_Spinner();
